...
class RefinementPlanner_sl_noobs:
    ...
    def build_cost_function(self, objective, control_variables, ego_state, ref_line_info, left_bound, right_bound, yaw, weights, vectorize=True):
    ...
    def plan(self, ego_state, best_lateral_sampling_frenet, best_ref_path, left_bound, right_bound, yaw):
        # initial plan
